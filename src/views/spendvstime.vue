...
export default {
  ...
  data: () => ({
    isloading: false,
    loadingText: 'Loading Year Vs Household Details',
    labels: [],
    data: [],
    ChartMsg: 'No Data',
  ...
  methods: {
    async getSpendData () {
      ...
      await Axios.get('https://ccmidterm1.azurewebsites.net/backend/getspendvstime/').then((data)=>{
          this.data=[{data:data.data.values,name:"Expenditure"}]
